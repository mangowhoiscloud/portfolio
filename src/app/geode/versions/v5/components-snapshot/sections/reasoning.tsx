            ...
            <div>
              <div className="overflow-x-auto -mx-4 px-4 pb-2 mb-6">
                <svg viewBox="0 0 760 200" className="w-full min-w-[560px]" style={{ maxHeight: 230 }}>
                  ...
                  <text x={700} y={60} textAnchor="middle" fill="#F5C542" fillOpacity={0.3} fontSize={8} fontFamily="ui-monospace, monospace">10 steps</text>
                  ...
                  <text x={700} y={104} textAnchor="middle" fill="#818CF8" fillOpacity={0.3} fontSize={8} fontFamily="ui-monospace, monospace">6 steps</text>
