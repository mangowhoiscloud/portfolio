            ...
            <div className="rounded-xl border border-[#C084FC]/10 bg-[#C084FC]/[0.02] p-6">
              ...
              <div className="space-y-1.5 font-mono text-[11px]">
                <div className="flex justify-between">
                  ...
                  <span><span className="text-[#F5C542]">82.2</span> <span className="text-[#7A8CA8]">S</span></span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/50">Cowboy Bebop</span>
                  <span><span className="text-[#818CF8]">69.4</span> <span className="text-[#7A8CA8]">A</span></span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/50">Ghost in the Shell</span>
                  <span><span className="text-[#4ECDC4]">54.0</span> <span className="text-[#7A8CA8]">B</span></span>
                </div>
              </div>
            </div>
