  ...
  return (
    <div className="w-full overflow-x-auto -mx-6 px-6 pb-4">
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full min-w-[600px]" style={{ maxHeight: 260 }}>
        ...
        <text x={xRouter} y={yMid + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">6-Route</text>
        ...
        <text x={xCortex} y={yCortex + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">SQL</text>
        ...
        <text x={xSignals} y={ySignals + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">MCP</text>
        ...
        {analysts.map((a) => (
          <g key={a.label}>
            ...
            <text x={xAnalysts} y={a.y + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">{a.sub}</text>
          </g>
        ))}
        ...
        <text x={xEval} y={yMid + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">Cross</text>
        ...
        <text x={xScoring} y={yMid + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">PSM</text>
        ...
        <text x={xSynth} y={yMid + 9} textAnchor="middle" fill="#5A6A8A" fontSize={8} fontFamily="ui-monospace, monospace">Report</text>
      </svg>
    </div>
  );
}
