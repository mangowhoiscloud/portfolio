            ...
            <div>
              <div className="overflow-x-auto -mx-4 px-4 pb-2 mb-6">
                <svg viewBox="0 0 740 180" className="w-full min-w-[540px]" style={{ maxHeight: 210 }}>
                  ...
                  <text x={587} y={80} textAnchor="middle" fill="#F4B8C8" fillOpacity={0.3} fontSize={7} fontFamily="ui-monospace, monospace">primary</text>
                  ...
                  <text x={677} y={80} textAnchor="middle" fill="#34D399" fillOpacity={0.3} fontSize={7} fontFamily="ui-monospace, monospace">secondary</text>
                ...
                <table className="w-full text-xs font-mono border-collapse min-w-[400px]">
                  <thead>
                    <tr className="border-b border-white/[0.06]">
                      <th className="text-left py-2 px-3 text-[#5A6A8A]">Model</th>
                      <th className="text-left py-2 px-3 text-[#5A6A8A]">역할</th>
                      <th className="text-right py-2 px-2 text-[#5A6A8A]">Input</th>
                      <th className="text-right py-2 px-2 text-[#5A6A8A]">Output</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div>
              <div className="overflow-x-auto -mx-4 px-4 pb-2 mb-6">
                <svg viewBox="0 0 760 200" className="w-full min-w-[560px]" style={{ maxHeight: 230 }}>
                  ...
                  <text x={195} y={72} textAnchor="middle" fill="#E87080" fillOpacity={0.3} fontSize={7} fontFamily="ui-monospace, monospace">fail</text>
                  ...
                  <text x={375} y={72} textAnchor="middle" fill="#E87080" fillOpacity={0.3} fontSize={7} fontFamily="ui-monospace, monospace">fail</text>
                  ...
                  <text x={555} y={72} textAnchor="middle" fill="#E87080" fillOpacity={0.3} fontSize={7} fontFamily="ui-monospace, monospace">fail</text>
                  ...
                  {/* Retry policy */}
                  <text x={380} y={145} textAnchor="middle" fill="white" fillOpacity={0.15} fontSize={9} fontFamily="ui-monospace, monospace">
