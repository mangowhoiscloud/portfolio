    ...
    <section className="relative py-36 px-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          {bigNumbers.map((item) => (
            ...
            >
              ...
              <div className="text-[10px] font-mono text-[#5A6A8A] leading-relaxed mt-auto">{item.detail}</div>
            </motion.div>
          ))}
        </ScrollRevealGroup>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {orchestrationItems.map((item) => (
              ...
              >
                ...
                <div className="text-[10px] text-[#5A6A8A]">{item.detail}</div>
              </div>
            ))}
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.3}>
          <p className="mt-10 text-center text-xs text-[#5A6A8A] font-mono">
