...
const phases = [
  ...
  },
  {
    ...
    badge: "FORK",
    badgeColor: "#C084FC",
    versions: ["v0.21", "83/83 tests", "$388 / 1,133 rounds"],
  },
];
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2.5 mb-1.5">
                    ...
                    <span className="text-[10px] font-mono text-[#5A6A8A]">{p.period}</span>
                    <span
                  ...
                  <p className="text-sm text-[#5A6A8A] leading-relaxed mb-3">{p.desc}</p>
        ...
        <ScrollReveal delay={0.4}>
          <div className="mt-20 flex items-center justify-center gap-4">
            ...
            <Link href="/" className="text-xs font-mono text-[#5A6A8A] hover:text-[#8B9CC0] transition-colors">
              ← Back to portfolio
            </Link>
          </div>
        </ScrollReveal>
