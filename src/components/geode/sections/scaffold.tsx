...
const components = [
  ...
  { label: "18 Skills", sub: "Progressive Disclosure 3-tier", subEn: "Progressive Disclosure 3-tier", color: "#F5C542", badge: "inject" },
  { label: "48 Hooks", sub: "15카테고리 이벤트 버스", subEn: "15-Category Event Bus", color: "#4ECDC4", badge: "event" },
