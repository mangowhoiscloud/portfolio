...
const subAgentDetails = [
  ...
  { title: "Tool Inheritance + Sandbox", color: "#4ECDC4",
    descKo: "부모의 47 native + 44 MCP + skills 전체 상속. 6개 위험 도구(set_api_key, manage_auth, profile_update, calendar_create/sync, delegate_task) 샌드박스 차단. auto_approve=True(STANDARD만).",
    descEn: "Inherits all parent tools: 47 native + 44 MCP + skills. 6 dangerous tools (set_api_key, manage_auth, profile_update, calendar_create/sync, delegate_task) sandbox-blocked. auto_approve=True (STANDARD only)." },
