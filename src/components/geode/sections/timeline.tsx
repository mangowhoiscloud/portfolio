...
const phases = [
  ...
  },
  {
    ...
    desc: "Scaffold(CLAUDE.md + CI) → Runtime(48 Hooks + 18 Skills) → Loop(while True + 8 Guards) 3중 구조 완성. Slack Gateway, SubAgent DAG, 4.5-Tier Memory, LLM Resilience.",
    descEn: "Completed 3-layer structure: Scaffold (CLAUDE.md + CI) → Runtime (48 Hooks + 18 Skills) → Loop (while True + 8 Guards). Slack Gateway, SubAgent DAG, 4.5-Tier Memory, LLM Resilience.",
    badge: "CURRENT",
    badgeEn: "CURRENT",
    badgeColor: "#4ECDC4",
