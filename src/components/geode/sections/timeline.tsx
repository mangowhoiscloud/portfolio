...
const phases = [
  ...
  },
  {
    ...
    desc: "Scaffold(CLAUDE.md + CI) → Runtime(40 Hooks + 25 Skills) → Loop(while True + 8 Guards) 3중 구조 완성. Slack Gateway, SubAgent DAG, 4-Tier Memory, Long-running Agent.",
    descEn: "Completed 3-layer structure: Scaffold (CLAUDE.md + CI) → Runtime (40 Hooks + 25 Skills) → Loop (while True + 8 Guards). Slack Gateway, SubAgent DAG, 4-Tier Memory, Long-running Agent.",
    badge: "CURRENT",
    badgeEn: "CURRENT",
    badgeColor: "#4ECDC4",
